...
import com.example.piceditor.AndroidUtils.filter_bw
import com.example.piceditor.AndroidUtils.filter_clr1
import com.example.piceditor.AndroidUtils.filter_clr2
import com.example.piceditor.AndroidUtils.filter_dark
import com.example.piceditor.AndroidUtils.filter_duo
import com.example.piceditor.AndroidUtils.filter_elegant
import com.example.piceditor.AndroidUtils.filter_euro
import com.example.piceditor.AndroidUtils.filter_film
import com.example.piceditor.AndroidUtils.filter_fresh
import com.example.piceditor.AndroidUtils.filter_golden
import com.example.piceditor.AndroidUtils.filter_ins
import com.example.piceditor.AndroidUtils.filter_lomo
import com.example.piceditor.AndroidUtils.filter_movie
import com.example.piceditor.AndroidUtils.filter_pink
import com.example.piceditor.AndroidUtils.filter_retro
import com.example.piceditor.AndroidUtils.filter_tint
...
//            overlay_light.setImageBitmap((overlay_light.drawable as BitmapDrawable).bitmap)
    ...
    inner class OptionAdapter : RecyclerView.Adapter<OptionAdapter.OptionHolder>() {
        ...
        override fun onBindViewHolder(holder: OptionHolder, @SuppressLint("RecyclerView") position: Int) {
    ...
    inner class LightAdapter(effectList: Array<EffectData>, imageview: ImageView) :
        ...
        override fun onBindViewHolder(holder: LightHolder, @SuppressLint("RecyclerView") position: Int) {
    ...
    inner class BlendTypeAdapter(images: Array<Int>) :
        ...
        override fun onBindViewHolder(holder: BlendTypeHolder, @SuppressLint("RecyclerView") position: Int) {
...
//                        )
    ...
    inner class BlendAdapter(images: Array<Int>) :
        ...
        override fun onBindViewHolder(holder: BlendHolder, @SuppressLint("RecyclerView") position: Int) {
    ...
    inner class AdjustAdapter : RecyclerView.Adapter<AdjustAdapter.AdjustHolder>() {
        ...
        override fun onBindViewHolder(holder: AdjustHolder, @SuppressLint("RecyclerView") position: Int) {
